...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v0.3.0/flexsearch.min.js');loadScript('/v0.3.0/en.search-data.min.ef45cf4a5066d71549041f8faac5c964ee7d2ca0d98c15ed2e7e897fc77b939e.js',function(){input.required=false;search();});}
