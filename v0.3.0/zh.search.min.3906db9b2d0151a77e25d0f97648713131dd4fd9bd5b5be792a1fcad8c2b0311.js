...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v0.3.0/flexsearch.min.js');loadScript('/v0.3.0/zh.search-data.min.08e1adce9fdc65d1922d6d8a95e372ff4dcae3d32f030656c1797b48d4f4363c.js',function(){input.required=false;search();});}
