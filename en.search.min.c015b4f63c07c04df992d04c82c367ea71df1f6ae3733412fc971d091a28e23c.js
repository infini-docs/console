...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b4e28aa644ac128fc438f8c1a0dfff253534a5a2a2d6d623b2373021aeff7cab.js',function(){input.required=false;search();});}
