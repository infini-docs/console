...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f52ead3a54d50a11350c275bf92f1b753cf6fa2d0050c1a58678c150724055de.js',function(){input.required=false;search();});}
