...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c44da78a8ae871c462e6664bee768756b88fdbf4304225a0dcff9a5d9cbf6fd2.js',function(){input.required=false;search();});}
