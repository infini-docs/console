...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.435d061b73e895fbb14a04cce3dec1ead289bd5acb0a02dbf95ee8a8110d1f10.js',function(){input.required=false;search();});}
