...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4bb67fafa78ecafae78bb2a3d120e5e99cec4d9de8ab2edcaddd5e3d57787b83.js',function(){input.required=false;search();});}
