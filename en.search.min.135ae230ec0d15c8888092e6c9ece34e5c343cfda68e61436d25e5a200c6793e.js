...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.633e8323ef426e16e8ad38dd623d035682bf5242057717ce9a30ccb08cdffb1d.js',function(){input.required=false;search();});}
