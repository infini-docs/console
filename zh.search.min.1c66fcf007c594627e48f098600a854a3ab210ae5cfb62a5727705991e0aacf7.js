...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.ee0357c1166a2ae59c83c10f27e670cd05eb6f87ae9db810532edc36d38e9a02.js',function(){input.required=false;search();});}
